...
coverage. Issue #101 remains blocked by #96 after #37 satisfied its roster
lifecycle dependency. The aggregate gate remains pending until every member and
`EVAL-CYCLE-340-001` pass.
